...
VALUES
    ...
    (2, 10, '2023-11-30 13:56:02.845258', '2023-11-30 13:56:02.845258'),  -- Transportation
    (3, 10, '2023-11-30 13:56:02.845258', '2023-11-30 13:56:02.845258'),  -- Food
    ...
    (6, 10, '2023-11-30 13:56:02.845258', '2023-11-30 13:56:02.845258'),   -- Medical & Healthcare
    (7, 10, '2023-11-30 13:56:02.845258', '2023-11-30 13:56:02.845258'),  -- Saving, Investing, & Debt Payments
...
BEGIN
    FOR distribution_record IN (SELECT * FROM expected_category_distribution) LOOP
        ...
        distribution := distribution_record.distribution;

        -- Generate a random percentage within the specified distribution
        random_percentage := floor(random() * distribution);
